=== Added to Cart Popup Notification for WooCommerce ===
Contributors: yagniksangani
Tags: woocommerce, cart, add to cart, notification, popup
...
= 1.0.0 =
* Initial release. Enjoy seamless notification integration with WooCommerce!